  ...
  if (!report) {
    return (
      <div className="text-center p-16 bg-white rounded-3xl border border-blue-50 shadow-sm flex flex-col items-center">
        ...
        <Link href="/superadmin" className="text-blue-600 font-semibold hover:underline">Kembali ke Dashboard</Link>
      </div>
    );
  }
      ...
      <div className="w-full max-w-4xl flex flex-col gap-6">
        ...
        <div className="bg-white p-7 rounded-3xl border border-gray-100 shadow-sm">
          ...
          {comments.length > 0 ? (
            ...
            <div className="text-center py-10 bg-gray-50/50 rounded-2xl border border-gray-100 flex flex-col items-center gap-3 text-gray-500">
