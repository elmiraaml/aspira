  ...
  <div className="flex flex-col items-center pt-5 pb-5 px-4">
    <div className="w-14 h-14 rounded-xl bg-gray-900 flex items-center justify-center text-white text-xl font-semibold">
